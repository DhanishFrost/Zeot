...
class CheckoutAddress extends Component
{
    ...
    public $selectedAddressData = null;
    ...
    public function selectAddress($selectedAddressId)
    {
        
        $selectedAddressData = userAddress::findOrFail($selectedAddressId);
        
        session()->put('selectedAddressData', $selectedAddressData);
    }
