        ...
        <ul class="py-4 space-y-1">
            ...
            <li class="px-5">
                <div class="flex flex-row items-center h-8">
                    <div class="text-sm font-light tracking-wide text-gray-100">Manage Profile</div>
                </div>
            </li>
            <li>
                <a href="{{ route('users.userProfile') }}"
                    ...
                    <i class="fa fa-user ml-4 text-white" style="font-size:20px"></i>
                    <span class="ml-4 text-sm truncate text-white">My Profile</span>
                </a>
            </li>
            <li>
                <a href="{{ route('users.addressBook') }}"
                    class="flex items-center h-11 hover:bg-gray-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <i class="fa fa-address-book ml-4 text-white" style="font-size:20px"></i>
                    <span class="ml-4 text-sm truncate text-white">Address Book</span>
                </a>
            </li>
            <li>
                <a href="{{ route('users.orderHistory') }}"
                    ...
                    <span class="ml-4 text-sm truncate text-white">My Orders</span>
                </a>
            </li>
            <li>
                <a href="{{ route('users.cart') }}"
                    class="flex items-center h-11 hover:bg-gray-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <i class="fa fa-shopping-cart ml-4 text-white" style="font-size:20px"></i>
                    <span class="ml-4 text-sm truncate text-white">My Cart</span>
                </a>
            </li>
            <li class="px-5">
                <div class="flex flex-row items-center h-8">
                    <div class="text-sm font-light tracking-wide text-gray-100">Back to Shopping</div>
                </div>
            </li>
            <li>
                <a href="{{ route('home') }}"
                    class="flex items-center h-11 hover:bg-gray-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <i class="fa fa-home ml-4 text-white" style="font-size:18px"></i>
                    <span class="ml-4 text-sm truncate text-white">Home</span>
                </a>
            </li>
            <li>
                <a href="{{ route('product.userProduct') }}"
                    class="flex items-center h-11 hover:bg-gray-500 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                    <i class="fa fa-store ml-4 text-white" style="font-size:18px"></i>
                    <span class="ml-4 text-sm truncate text-white">Products</span>
                </a>
            </li>
            <li>
