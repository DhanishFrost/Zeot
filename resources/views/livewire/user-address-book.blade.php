<div>
    <div x-data="{ show: @entangle('showPopup') }" class="lg:pl-80 mx-2 pt-8 pb-4">
    ...
    <div class="mx-2 lg:pl-80 lg:mr-12">
        @if ($addresses !== null)
            <div class="grid grid-cols-2 gap-6">
                @foreach ($addresses as $address)
                    <div class="border p-4 rounded-md shadow-md relative">
                        ...
                        <p class="text-lg pb-2">{{ $address->name }}</p>
                        <p class="text-lg pb-2">(+94) {{ $address->phone }}</p>
                        <p class="text-lg pb-2">{{ $address->city }}, {{ $address->area }} - {{ $address->address }}
                        </p>
                        <p class="text-sm pb-2 text-cyan-700">{{ $address->address_type }}</p>
                    </div>
                @endforeach
            </div>
        @else
